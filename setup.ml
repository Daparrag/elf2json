...
(* OASIS_START *)
(* DO NOT EDIT (digest: e63fcb7e65cc2d822180a952e69cd0a3) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          authors = ["m4b"];
          homepage = Some "http://github.com/m4b/elf2json";
            ...
            [
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("rdr", None);
                           FindlibPackage ("rdr.elf", None)
                        ];
                   ...
                   },
                   {
                      lib_modules =
                        [
                           "E2j";
                           "E2j_ElfHeader";
                           "E2j_ElfProgramHeader";
                           "E2j_ElfSectionHeader";
                           "E2j_ElfSymbolTable";
                           "E2j_ElfDynamic";
                           "E2j_ByteCoverage";
                           "E2j_ElfReloc";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "elf2json.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "Ìó\021Ä\029\014\007\128?\029F\006\001Ï:²";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
